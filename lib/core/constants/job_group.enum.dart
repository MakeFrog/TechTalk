...
enum JobGroup {
  ...
  MACHINE_LEARNING_ENGINEER('machine-learning-engineer', '머신러닝 엔지니어', 'Machine Learning Engineer'),
  SYSTEM_NETWORK_ADMINISTRATOR('system-network-administrator', '시스템,네트워크 관리자', 'System/Network Administrator'),
  ANDROID_DEVELOPER('android-developer', '안드로이드 개발자', 'Android Developer'),
  DATA_ENGINEER('data-engineer', '데이터 엔지니어', 'Data Engineer'),
  DEVOPS_SYSTEM_ADMINISTRATOR('devops-system-administrator', 'DevOps / 시스템 관리자', 'DevOps/System Administrator'),
  ...
  CROSS_PLATFORM_APP_DEVELOPER('cross-platform-app-developer', '크로스플랫폼 앱 개발자', 'Cross-Platform App Developer'),
  BLOCKCHAIN_PLATFORM_ENGINEER('blockchain-platform-engineer', '블록체인 플랫폼 엔지니어', 'Blockchain Platform Engineer'),
  ...
  AUDIO_VIDEO_ENGINEER('audio-video-engineer', '영상,음성 엔지니어', 'Audio/Video Engineer'),
  ...
  RUBY_ON_RAILS_DEVELOPER('ruby-on-rails-developer', '루비온레일즈 개발자', 'Ruby on Rails Developer');
