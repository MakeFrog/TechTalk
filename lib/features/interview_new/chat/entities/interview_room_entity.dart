import 'package:techtalk/features/interview_new/chat/entities/interview_progress_info_entity.dart';
import 'package:techtalk/features/interview_new/chat/entities/interviewer_avatar.dart';
import 'package:techtalk/features/interview_new/chat/entities/states/interview_progress_state.enum.dart';
import 'package:techtalk/features/interview_new/chat/entities/states/interview_result_state.enum.dart';
...
class InterviewRoomEntity {
  ...
  final InterviewTopicData topic;
...
//<editor-fold desc="Data Methods">
  ...
  factory InterviewRoomEntity.fromMap(Map<String, dynamic> map) {
    return InterviewRoomEntity(
      ...
      topic: map['topic'] as InterviewTopicData,
