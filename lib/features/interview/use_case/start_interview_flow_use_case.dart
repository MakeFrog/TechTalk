...
final class StartInterviewFlowUseCase {
  ...
  Future<void> executeProficiencyInterviewFlow() async {
    ...
    final selectedTopics = await _interviewFlowParam.topicSelectionCompleter.future;
    ...
    final selectedLevel = await _interviewFlowParam.levelSelectionCompleter.future;
    ...
    final selectedQuestionCount = await _interviewFlowParam.questionCountCompleter.future;
  ...
  void _navigateToTopicSelection() {
    final routeArgument = ProficiencyInterviewTopicSelectionRouteArgument(_interviewFlowParam);
  ...
  void _navigateToLevelSelection() {
    ...
    InterviewLevelSelectionRoute(routeArgument).push(_context).whenComplete(() async {
      if (!_interviewFlowParam.levelSelectionCompleter.isCompleted) {
