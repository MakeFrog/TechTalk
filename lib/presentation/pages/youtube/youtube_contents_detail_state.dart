...
import 'package:techtalk/presentation/pages/youtube/providers/youtube_contents_detail_provider.dart';
import 'package:techtalk/presentation/pages/youtube/providers/youtube_contents_detail_qnas_provider.dart';
...
mixin class YoutubeContentsDetailState {
  ...
  ///
  AsyncValue<YoutubeContentsDetailEntity> youtubeContentsDetailAsync(WidgetRef ref, String contentsId) =>
      ref.watch(youtubeContentsDetailProvider(contentsId));

  ///
  /// 테크톡 DB에서 불러오는 해당 비디오 컨텐츠 데이터
  ///
  AsyncValue<List<QnaEntity>> youtubeContentsDetailQnasAsync(WidgetRef ref, String contentsId) =>
