...
enum RecordProgressState {
  initial(null, null, Assets.iconsIconMic), // 음성 인식을 시작할 준비가 된 상태
  ready(null, Colors.black, Assets.iconsArrowLeft), // 음성 인
  onProgress('듣고 있어요', null, Assets.iconsArrowLeft), // 음성 인식 중인 상태
  recognized(null, null, Assets.iconsSend), // 음성 인식 후 텍스트가 처리된 상태
  submitMessage(null, null, Assets.iconsSend), // 메시지를 전송하고 있는 상태
