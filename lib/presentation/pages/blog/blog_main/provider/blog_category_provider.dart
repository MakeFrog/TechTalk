...
class BlogContentCategoryProvider extends ChangeNotifier {
  ...
  /// 선택된 카테고리
  ///
  ContentFilterCategory selectedCategory;

  ///
  /// 전체 카티고리 리스트
  ///
  final List<ContentFilterCategory> totalCategories;

  ///
  /// 선택된 카테고리 토글
  ///
  void toggleCategorySelection(ContentFilterCategory targetCategory) {
