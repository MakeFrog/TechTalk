...
String _$studyQuestionsHash() => r'e2dd2bacb9bf671859ba3480edf42b38c373a547';
...
abstract class _$StudyQuestions
    extends BuildlessAutoDisposeAsyncNotifier<List<InterviewQuestionEntity>> {
  late final String topicId;

  FutureOr<List<InterviewQuestionEntity>> build(
    String topicId,
  );
}
...
class StudyQuestionsFamily
    extends Family<AsyncValue<List<InterviewQuestionEntity>>> {
  /// See also [StudyQuestions].
...
class StudyQuestionsProvider extends AutoDisposeAsyncNotifierProviderImpl<
    StudyQuestions, List<InterviewQuestionEntity>> {
  /// See also [StudyQuestions].
  ...
  @override
  FutureOr<List<InterviewQuestionEntity>> runNotifierBuild(
  ...
  AutoDisposeAsyncNotifierProviderElement<StudyQuestions,
      List<InterviewQuestionEntity>> createElement() {
...
mixin StudyQuestionsRef
    on AutoDisposeAsyncNotifierProviderRef<List<InterviewQuestionEntity>> {
...
class _StudyQuestionsProviderElement
    extends AutoDisposeAsyncNotifierProviderElement<StudyQuestions,
        List<InterviewQuestionEntity>> with StudyQuestionsRef {
