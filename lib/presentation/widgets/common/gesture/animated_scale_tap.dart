...
class ShrinkGestureView extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _ShrinkGestureViewState();
}

class _ShrinkGestureViewState extends State<ShrinkGestureView>
    with SingleTickerProviderStateMixin<ShrinkGestureView> {
